...
- Name: Jornada E2E: Geração de Conteúdo >> Fluxo principal: geração, status, SSE, download, a11y e visual
- Location: C:\Users\SEDUC\Desktop\PROJETOS\omni_gerador_artigos\tests\e2e\test_generate_content.spec.ts:40:7
...
Locator: locator('[data-testid="download-link"]')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 60000ms
  - waiting for locator('[data-testid="download-link"]')

    at C:\Users\SEDUC\Desktop\PROJETOS\omni_gerador_artigos\tests\e2e\test_generate_content.spec.ts:79:65
```
...
- main:
  ...
  - list:
    - listitem:
      - text: Instância E2E [openai] fake...-key 1. Teste E2E fluxo real.
      - button "Editar"
      - button "Remover"
...
```ts
   1 | import { test, expect, Page, Download } from '@playwright/test';
   2 | import AxeBuilder from '@axe-core/playwright';
   3 | import fs from 'fs';
   4 |
   5 | // Configurações globais
   6 | const BASE_URL = 'http://localhost:5000';
   7 | const API_KEY = process.env.TEST_API_KEY || 'fake-api-key';
   8 | const MODEL_TYPE = 'openai';
   9 | const PROMPT = 'Teste E2E fluxo real.';
   10 | const INVALID_API_KEY = 'invalid-key';
   11 | const mockWebhookUrl = 'http://localhost:9999/webhook-mock';
   12 |
   13 | // Utilitários
